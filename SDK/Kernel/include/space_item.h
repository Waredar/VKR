...
enum MbeSpaceType {
  ...
  st_SimplexSurface           = 322,  ///< \ru Треугольная NURBS поверхность, определяемая точками. \en Triangular NURBS surface.
  ...
  st_Polymesh                 = 512,  ///< \ru Полигональный объект с топологией. \en Polygonal object with topology.
