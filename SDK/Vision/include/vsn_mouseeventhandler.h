...
public:
    ...
    /// \ru Сигнал выдается при изменении положения мыши. \en NO TRANSLATION. \~
    VSN_SIGNAL(Public, MouseEnter, void MouseEnter(MouseEventObject* pMouse), pMouse)
    /// \ru Сигнал выдается при изменении положения мыши. \en NO TRANSLATION. \~
    VSN_SIGNAL(Public, MouseLeave, void MouseLeave(MouseEventObject* pMouse), pMouse)
