...
public:
    ...
    */
    ...
    /** \brief \ru Конструктор для чтения из файла на диске.
               \en Constructor for reading from disk. \~
        \param[in] path - \ru Путь к файлу.
                          \en File path. \~
    */
...
public:
    ...
    */
    ...
    Image GetDark(uint8_t value) const;
    Image GetLight(uint8_t value) const;
    Image GetGray() const;
    Color GetColor(size_t x, size_t y) const;
    void  SetColor(size_t x, size_t y, Color);
private:
