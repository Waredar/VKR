...
/* LightParameters */
struct [[deprecated("Do not use this class, it will be removed.")]] LightParameters
{
    ...
    Point3DF   position;        /// позиция источника освещения
    Vector3DF  spotDirection;   /// направление источника освещения
    ...
    bool bStaticLight = false;       /// флаг позиция источника освещения
};
...
public:
    ...
    VSN_DEPRECATED_X("Do not use this constructor, it will be deleted.")
...
public:
    ...
    /// \ru Вернуть флаг позиции источника света. \en  Returns flag the position of the light source.
    bool IsStaticLight() const;
    /// \ru Установить флаг позиции источника света. \en Sets flag the position of the light source.
    void SetStaticLight(bool exponent);
public:
