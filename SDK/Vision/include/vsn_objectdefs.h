...
#  define VSN_PRINTABLE(str)  std::string(str)
#endif
...
#define V_STATIC_META_OBJECT_IMPL(class_name) \
    static const VSN::TMetaObjectRealization<class_name>& GetStaticMetaObject() \
    { \
        static std::shared_ptr<VSN::TMetaObjectRealization<class_name>> createdMetaObject(nullptr); \
        if (createdMetaObject) \
            return *createdMetaObject.get(); \
        /*first mutex*/\
        VSN::MutexLocker lock(&GetMetaObjectMutex()); \
        ...
        VSN::TMetaObjectRealization<class_name>* pNewMeta = nullptr; \
        if (it == metaMap.end()) \
        { \
            pNewMeta = new VSN::TMetaObjectRealization<class_name>();  \
            metaMap[std::type_index(typeid(vsn_class))] = pNewMeta; \
            /*std::atomic_store(&createdMetaObject, std::shared_ptr<VSN::TMetaObjectRealization<class_name>>(pNewMeta)); */\
        ...
        { \
            pNewMeta = dynamic_cast<VSN::TMetaObjectRealization<class_name> *> (it->second); \
            /*std::atomic_store(&createdMetaObject, std::shared_ptr<VSN::TMetaObjectRealization<class_name>>(pNewMeta));*/ \
            createdMetaObject.reset( pNewMeta );\
            return *pNewMeta; \
        } \
...
#define VSN_OBJECT_BASE(class_name) \
   public: \
      static const char* vsn_className() { static const char* retval = #class_name; return retval; } \
      ...
      friend VSN::TMetaObjectRealization<class_name>; \
...
#define VSN_PROPERTY_READ(name, method) \
   ...
   static void vsn_Overload(VSN_VALUE_NUMBER<VSN_SYMBOL_INSERT2(VSN_NUM_VALUE_COUNTER, __LINE__)>)  \
      {  \
         const_cast<VSN::TMetaObjectRealization<vsn_class>&>(vsn_class::GetStaticMetaObject())   \
...
#define VSN_PROPERTY_NOTIFY(name, method) \
   ...
   static void vsn_Overload(VSN_VALUE_NUMBER<VSN_SYMBOL_INSERT2(VSN_NUM_VALUE_COUNTER, __LINE__)>)  \
      {  \
         const_cast<VSN::TMetaObjectRealization<vsn_class>&>(vsn_class::GetStaticMetaObject()).BindPropNotify(#name, &vsn_class::method); \
         \
         vsn_Overload(VSN_VALUE_NUMBER<VSN_SYMBOL_INSERT2(VSN_NUM_VALUE_COUNTER, __LINE__) + 1>{} ); \
      }
...
#define VSN_PROPERTY_READ_NOTIFY(name, rMethod, nMethod) \
   ...
   {  \
         const_cast<VSN::TMetaObjectRealization<vsn_class>&>(vsn_class::GetStaticMetaObject())   \
            ...
            std::make_shared<ShadeRead<vsn_class, vsn_returnType< decltype(&vsn_class::rMethod) >::type>> (&vsn_class::rMethod));  \
       \
         const_cast<VSN::TMetaObjectRealization<vsn_class>&>(vsn_class::GetStaticMetaObject()).BindPropNotify(#name, &vsn_class::nMethod); \
       \
         vsn_Overload(VSN_VALUE_NUMBER<VSN_SYMBOL_INSERT2(VSN_NUM_VALUE_COUNTER, __LINE__) + 1>{} ); \
    }
...
#define VSN_INVOKABLE_METHOD_2(methodName) \
         const_cast<VSN::TMetaObjectRealization<vsn_class>&>(vsn_class::GetStaticMetaObject()).BindMethod(  \
...
#define VSN_SIGNAL_IMPL_1(access, ...) \
   ...
   static void vsn_Overload(VSN_VALUE_NUMBER<VSN_SYMBOL_INSERT2(VSN_NUM_VALUE_COUNTER, __LINE__)>) \
      {  \
         const_cast<VSN::TMetaObjectRealization<vsn_class>&>(vsn_class::GetStaticMetaObject()).BindMethodBegin(  \
...
#define VSN_SIGNAL_IMPL_2(signalName, ...) \
   ...
   static void vsn_Overload(VSN_VALUE_NUMBER<VSN_SYMBOL_INSERT2(VSN_NUM_VALUE_COUNTER, __LINE__)>) \
            {  \
         const_cast<VSN::TMetaObjectRealization<vsn_class>&>(vsn_class::GetStaticMetaObject()).BindMethodEnd(  \
