...
*/
    ...
    else
    {
        ...
        VSN_ASSERT(false); // необходима ф-ция MetaTypeIdQuery
/*
...
R AbsReadBase::run(const Object* obj) const
{
    ...
    if (const AbsRead<R>* pCheck = dynamic_cast<const AbsRead<R> *>(this))
        ...
        throw std::logic_error("Object::GetProperty() type mismatch in reading");
}
...
public:
    ...
    virtual std::unique_ptr<Internal::AbsStorageFunction> Duplicate() const override;
    using Internal::StorageFunction<T>::Invoke;
    virtual void Invoke(Object* receiver, const Internal::AbsStorageTuple* dataPack, ArgReturnCommon* retval = 0) const override;
    virtual bool CheckReturnType(ArgReturnCommon& retval) const override;
};
