...
public:
    ...
    friend inline Color operator*(float f, const Color& v);
    friend inline Color operator-(const Color& v, float f);
    friend inline Color operator-(float f, const Color& v);
...
{ return Color(f * v.GetRedF(), f * v.GetGreenF(), f * v.GetBlueF(), f * v.GetAlphaF()); }

inline Color operator*(float f, const Color& v)
{ return Color(f * v.GetRedF(), f * v.GetGreenF(), f * v.GetBlueF(), f * v.GetAlphaF()); }

inline Color operator-(const Color& v, float f)
{ return Color(v.GetRedF() - f, v.GetGreenF() - f, v.GetBlueF() - f, v.GetAlphaF() - f); }

inline Color operator-(float f, const Color& v)
{ return Color(f - v.GetRedF(), f - v.GetGreenF(), f - v.GetBlueF(), f - v.GetAlphaF()); }

inline Color operator-(const Color& v1, const Color& v2)
{ return Color(v1.GetRedF() - v2.GetRedF(), v1.GetGreenF() - v2.GetGreenF(), v1.GetBlueF() - v2.GetBlueF(), v1.GetAlphaF() - v2.GetAlphaF()); }
