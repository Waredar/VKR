...
public:
    MetaEnum();
    MetaEnum(const String& name, const String& scope, bool isFlag);
public:
    bool IsFlag() const;
    bool IsValid() const;
    ...
    int GetKeyToValue(const String& key) const;
    int GetKeysToValue(const String& keys) const;

    const String& GetName() const;
    const String& GetScope() const;

    void SetData(ObjectMap<String, int> valueMap);

    int GetValue(int index) const;
    const String& GetValueToKey(int value) const;
    String GetValueToKeys(int value) const;
private:
    String m_name;
    String m_scope;
    bool m_flag;
    ObjectMap<String, int> m_data;
};
...
public:
    MetaMethod(const String& typeName, const String& signature, const std::vector<String>& paramNames,
...
public:
    ...
    ObjectList<String> GetParameterNames() const;
    ObjectList<String> GetParameterTypes() const;

    int GetParameterCount() const;
    int GetParameterType(int index) const;

    const String& MethodSignature() const;
...
public:
    static const MetaMethod xMethod;
private:
...
public:
    ...
    MetaProperty(const String& name = String(), MetaObject* pObject = nullptr);
