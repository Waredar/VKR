...
public:
    ...
    /// \ru Активировать программу шейдера по идентификатору. \en Activates shader program by identifier. \~
    ...
    /// \ru Создать и слинковать программу шейдера, если линковка с ошибкой, то сработает исключение. \en Creates and links shader program. If linking error, then exception occurs. \~
