...
public:
    ...
    /// \ru Конструктор по ширине, длине и высоте. \en Constructor by width, length and height. \~
    BoxGeometry(float width, float length, float height, Node* pParent = nullptr);
