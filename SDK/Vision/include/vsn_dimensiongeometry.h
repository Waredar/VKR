...
public:
    ...
    /// \ru Установить пользовательское значение для размера. \en Sets user dimension value. \~
    void SetUserValue(double value);
    /// \ru Установить пользовательское значение для размера. Преобразование единиц во время отображения не применяется. \en Sets user dimension value.Unit conversion during display is not applicable. \~
    ...
    void SetVisibleExtensionLines(bool);
public:
...
public:
    ...
    /// \ru Вернуть видимость стрелок размера. \en Get the visibility of dimension arrows. \~
    bool IsArrowsVisible() const;
    /// \ru Установить видимость стрелок размера. \en Set the visibility of dimension arrows. \~
